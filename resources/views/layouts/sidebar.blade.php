    ...
    <nav class="flex-1 px-3 space-y-0.5">
        @foreach ($navGroups as $group)
            @if ($group['title'])
                ...
                <div class="sidebar-group {{ $loop->first ? '' : 'pt-4' }}">
                    <button
                        type="button"
                        data-collapse-group="{{ $group['title'] }}"
                    ...
                    >
                        ...
                        <span class="sidebar-arrow transition-transform duration-200">
                            <x-icon name="heroicon-o-chevron-down" class="h-3.5 w-3.5" />
                        </span>
                    </button>

                    <div class="sidebar-group-body space-y-0.5">
